...
export async function candidatarAction(vagaId: string) {
  try {
    ...
    console.error('Error in candidatarAction:', error)
    return { error: 'Erro interno ao realizar candidatura.' }
  }
}
...
export async function atualizarStatusCandidaturaAction(
  ...
  try {
    ...
    console.error('Error in atualizarStatusCandidaturaAction:', error)
    return { error: 'Erro interno ao atualizar status da candidatura.' }
  }
}
